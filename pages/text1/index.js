  ...
  return (
    <>
      ...
      <div className="theme theme_light site_russia1" id="page_article_show">
        ...
        <footer style={{backgroundColor: '#f0f0f0', padding: '20px 0', marginTop: '30px'}}>
          <div className="wrapper wrap footer-container" style={{maxWidth: '800px', margin: '0 auto', padding: '0 15px'}}>
            <div className="copy">
